...
public class Smithexport {
	public static void export(Sequence sequence1, Sequence sequence2,int tX,int tY, String path1, int window, boolean complementary, SubstitutionMatrix submat) throws IOException {
